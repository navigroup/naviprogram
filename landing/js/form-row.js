                ...
                <table class="form-box-tb">
                    ...
                    <tr>
                        <td colspan="2" style="border-bottom: none"> 
                            ...
                            <input class="submit-btn" type='submit' id='send_message' value='최저 비교 견적 신청하기' disabled style="background-color: #595858;">
...
<form id="db" name="inputForm" accept-charset="euc-kr" method="post" target="hidden_iframe12" action="https://dbdbdeep.com/site17/ifr/ifr_save.php">
