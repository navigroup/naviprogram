$(document).ready(function(){
    $('#send_message').click(function(){
        ...
        if(error == false){
           ...
           $('#form_e11').prop("action", "https://docs.google.com/forms/u/0/d/e/1FAIpQLSclcbgcGZSoOAHa49ARQGChkKQp8PidZiv6n1z1r19hXBFhlQ/formResponse");
...
function hoa(){
    ...
    $(window).scrollTop(0);
    window.location.href="./실전-홈페이지-제작.html";
